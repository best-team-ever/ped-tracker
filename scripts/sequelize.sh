...
./node_modules/.bin/sequelize model:generate --name locations --attributes location_type:string,name:string,address:string,country:sting,contact_name:string,contact_position:string,contact_phone:string,contact_email:string,status:string
